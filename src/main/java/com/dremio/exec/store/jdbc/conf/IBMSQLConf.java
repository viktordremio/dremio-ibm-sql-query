...
public class IBMSQLConf extends AbstractArpConf<IBMSQLConf> {
    ...
    static class IBMSQLSchemaFetcher extends JdbcSchemaFetcherImpl {

        public IBMSQLSchemaFetcher(JdbcPluginConfig config) {
            super(config);
        }
    ...
    public JdbcPluginConfig buildPluginConfig(
        ...
        logger.info("Connecting to IBMSQL");
    ...
    private CloseableDataSource newDataSource() {
        return DataSources.newGenericConnectionPoolDataSource(DRIVER,
                toJdbcConnectionString(), null, password, null,
